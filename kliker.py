...
def save():
    global check, coeff, upgrade_costs, rebirth_count, upgrade_end_count, \
        upgrade_costs_start, upgradexx_count, button, button_text, mouses, speed
...
def take_data():
    ...
    try:
        ...
        return (check, coeff, rebirth_count, upgrade_end_count, upgradexx_count,
                upgrade_costs, upgrade_costs_start, button, button_text, mouses, speed)
...
def mouse_cliker(upgrade_key):
    global check, coeff, upgrade_end_count, mouses
...
def rebirth(step=0):
    global check, coeff, rebirth_count, upgrade_end_count, upgradexx_count, mouses
...
def slider(value):
    value = int(value)
    koef_slider = 1
    button1.place(x=850, y=5 - value * koef_slider)
    button2.place(x=850, y=50 - value * koef_slider)
    button3.place(x=850, y=100 - value * koef_slider)
    button4.place(x=850, y=150 - value * koef_slider)
    button5.place(x=850, y=200 - value * koef_slider)
    button6.place(x=850, y=250 - value * koef_slider)
    button7.place(x=850, y=300 - value * koef_slider)
    button8.place(x=850, y=350 - value * koef_slider)
    button9.place(x=850, y=400 - value * koef_slider)
    button10.place(x=850, y=450 - value * koef_slider)
    button11.place(x=850, y=500 - value * koef_slider)
    button12.place(x=850, y=550 - value * koef_slider)
    button13.place(x=850, y=600 - value * koef_slider)
    button14.place(x=850, y=650 - value * koef_slider)
    button15.place(x=850, y=700 - value * koef_slider)
    button16.place(x=850, y=750 - value * koef_slider)
    button17.place(x=850, y=800 - value * koef_slider)

    buttonx2.place(x=850, y=850 - value * koef_slider)
    buttonx3.place(x=850, y=900 - value * koef_slider)
    ...
    label_upgradex2.place(x=1250, y=850 - value * koef_slider)
    label_upgradex3.place(x=1250, y=900 - value * koef_slider)


def update_labels():
    label_check.config(text=f"Счёт: {format_number(check)}")
    label_coeff.config(text=f"Сила клика: ×{format_number(coeff)}")
    label_rebirth.config(text=f"Ребитхи: {rebirth_count}")
    label_upgradeX.config(text=f"Последних улучшений: {upgrade_end_count}/5")
    label_upgrade1.config(text=f"Цена: {format_number(upgrade_costs['upgrade1'])}")
    label_upgrade2.config(text=f"Цена: {format_number(upgrade_costs['upgrade2'])}")
    label_upgrade3.config(text=f"Цена: {format_number(upgrade_costs['upgrade3'])}")
    label_upgrade4.config(text=f"Цена: {format_number(upgrade_costs['upgrade4'])}")
    label_upgrade5.config(text=f"Цена: {format_number(upgrade_costs['upgrade5'])}")
    label_upgrade6.config(text=f"Цена: {format_number(upgrade_costs['upgrade6'])}")
    label_upgrade7.config(text=f"Цена: {format_number(upgrade_costs['upgrade7'])}")
    label_upgrade8.config(text=f"Цена: {format_number(upgrade_costs['upgrade8'])}")
    label_upgrade9.config(text=f"Цена: {format_number(upgrade_costs['upgrade9'])}")
    label_upgrade10.config(text=f"Цена: {format_number(upgrade_costs['upgrade10'])}")
    label_upgrade11.config(text=f"Цена: {format_number(upgrade_costs['upgrade11'])}")
    label_upgrade12.config(text=f"Цена: {format_number(upgrade_costs['upgrade12'])}")
    label_upgrade13.config(text=f"Цена: {format_number(upgrade_costs['upgrade13'])}")
    label_upgrade14.config(text=f"Цена: {format_number(upgrade_costs['upgrade14'])}")
    label_upgrade15.config(text=f"Цена: {format_number(upgrade_costs['upgrade15'])}")
    label_upgrade16.config(text=f"Цена: {format_number(upgrade_costs['upgrade16'])}")
    label_upgrade17.config(text=f"Цена: {format_number(upgrade_costs['upgrade17'])}")

    label_upgradex2.config(text=f"Цена: {format_number(upgrade_costs['upgradex2'])}")
    label_upgradex3.config(text=f"Цена: {format_number(upgrade_costs['upgradex3'])}")
    label_upgrade_mouse.config(text=f"Цена: {format_number(upgrade_costs['upgrade_mouse'])}")
    label_mouse.config(text=f"Количество мышек: {mouses}\n    Скорость раз в: {speed} мс")
...
button1 = tk.Button(window, text="улучшение на 1", command=lambda: upgrade("upgrade1", 1), width=50, height=2)
button1.place(x=850, y=5)
button2 = tk.Button(window, text="улучшение на 2", command=lambda: upgrade("upgrade2", 2), width=50, height=2)
button2.place(x=850, y=50)
button3 = tk.Button(window, text="улучшение на 5", command=lambda: upgrade("upgrade3", 5), width=50, height=2)
button3.place(x=850, y=100)
button4 = tk.Button(window, text="улучшение на 8", command=lambda: upgrade("upgrade4", 8), width=50, height=2)
button4.place(x=850, y=150)
button5 = tk.Button(window, text="улучшение на 11", command=lambda: upgrade("upgrade5", 11), width=50, height=2)
button5.place(x=850, y=200)
button6 = tk.Button(window, text="улучшение на 17", command=lambda: upgrade("upgrade6", 17), width=50, height=2)
button6.place(x=850, y=250)
button7 = tk.Button(window, text="улучшение на 30", command=lambda: upgrade("upgrade7", 30), width=50, height=2)
button7.place(x=850, y=300)
button8 = tk.Button(window, text="улучшение на 50", command=lambda: upgrade("upgrade8", 50), width=50, height=2)
button8.place(x=850, y=350)
button9 = tk.Button(window, text="улучшение на 70", command=lambda: upgrade("upgrade9", 70), width=50, height=2)
button9.place(x=850, y=400)
button10 = tk.Button(window, text="улучшение на 130", command=lambda: upgrade("upgrade10", 130), width=50, height=2)
button10.place(x=850, y=450)
button11 = tk.Button(window, text="улучшение на 200", command=lambda: upgrade("upgrade11", 200), width=50, height=2)
button11.place(x=850, y=500)
button12 = tk.Button(window, text="улучшение на 300", command=lambda: upgrade("upgrade12", 300), width=50, height=2)
button12.place(x=850, y=550)
button13 = tk.Button(window, text="улучшение на 450", command=lambda: upgrade("upgrade13", 450), width=50, height=2)
button13.place(x=850, y=600)
button14 = tk.Button(window, text="улучшение на 750", command=lambda: upgrade("upgrade14", 750), width=50, height=2)
button14.place(x=850, y=650)
button15 = tk.Button(window, text="улучшение на 1000", command=lambda: upgrade("upgrade15", 1000), width=50, height=2)
button15.place(x=850, y=700)
button16 = tk.Button(window, text="улучшение на 1500", command=lambda: upgrade("upgrade16", 1500), width=50, height=2)
button16.place(x=850, y=750)
button17 = tk.Button(window, text="улучшение на 123", command=lambda: upgrade("upgrade16", 123), width=50, height=2)
button17.place(x=850, y=800)

#кнопки умножения
buttonx2 = tk.Button(window, text="умножение на 2", command=lambda: upgrade("upgradex2", 2), width=30, height=2)
buttonx2.place(x=850, y=850)
label_upgradex2 = tk.Label(window, text=f"Цена: {format_number(upgrade_costs['upgradex2'])}", font=("Comic Sans MS", 14, "bold"), fg="purple")
label_upgradex2.place(x=1250, y=850)
buttonx3 = tk.Button(window, text="умножение на 3", command=lambda: upgrade("upgradex3", 3), width=30, height=2)
buttonx3.place(x=850, y=900)
label_upgradex3 = tk.Label(window, text=f"Цена: {format_number(upgrade_costs['upgradex3'])}", font=("Comic Sans MS", 14, "bold"), fg="purple")
label_upgradex3.place(x=1250, y=900)

button_mouse = tk.Button(window, text=" автомышкааа!!!", command=lambda: mouse_cliker("upgrade_mouse"), width=30, height=2)
button_mouse.place(x=50, y=350)
label_upgrade_mouse = tk.Label(window, text=f"Цена: {format_number(upgrade_costs['upgrade_mouse'])}", font=("Comic Sans MS", 14, "bold"), fg="purple")
label_upgrade_mouse.place(x=300, y=350)
label_mouse = tk.Label(window, text=f"Количество мышек: {mouses}\n    Скорость раз в: {speed} мс", font=("Comic Sans MS", 12, "bold"), fg="purple")
label_mouse.place(x=20, y=400)
